...
<TABLE  border=0 >
	<TR>
		<TD><B>Patient's ID&nbsp;&nbsp;&nbsp</B></TD>
		<TD><Select Name="pat_id" SIZE=8 >

<% 
	try{
		Object res=rcpqi.getLPatqueueAdmin(center);
...
%>
	...
	<INPUT TYPE="hidden" name="com_type" value="Video Conferencing">
		<TD><B>Date of Communication</B></TD>

		<INPUT TYPE="hidden" NAME="com_date" value="<%=dat%>">
	<TR>
		<TD><B>Remote Center</B></TD>
		<TD>
			<SELECT NAME="remote_ccode">
...
%>
	...
	<TR>
		...
		<TD><INPUT name="remote_doc" size=21 maxlength=18 ><BR></TD>
	</TR>
	<TR>
		<TD><B>Comments</B></TD>
