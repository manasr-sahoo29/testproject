...
%>
	...
	<TR  height="20px">
		...
		<TD BGColor="#330000" class=td1><B><Font size=+1 >&nbsp;|&nbsp;</Font></B></TD>
		<TD BGColor="#330000" class=td1 ><A HREF=browseop.jsp target=bot onClick='selremote2()'>Local Patient</A></TD>
		<TD BGColor="#330000" class=td1><B><Font size=+1 >&nbsp;|&nbsp;</Font></B></TD>
	

	
	<!-- <TD BGColor="#330000" ><A HREF=telebrowse.jsp?rccode=<%=ccode%>  target=bot onClick='selremote1()'>&nbsp;Tele Patient</A></TD> -->
