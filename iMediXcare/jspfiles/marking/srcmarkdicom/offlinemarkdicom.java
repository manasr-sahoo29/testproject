...
public class offlinemarkdicom extends Applet implements MouseListener, MouseMotionListener,ActionListener
{	
	...
	public void init()
	{
		...
		try {
			...
			imgh=imgicon.getIconHeight();
 			...
 			e.printStackTrace();
 			JOptionPane.showMessageDialog(null, "EX1 : "+e.toString());
 		}
...
public void actionPerformed(ActionEvent ae){
	...
	private String callser()
	{
		...
		String location = url+ "/servlet/dicommarkservlet";
		...
		//String par="fmtpts="+fhand+"&id="+pid;
