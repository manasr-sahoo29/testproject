...
function chkpatid()
{
	...
	patid = document.serpat.id.value
	// id len should be 14
	if(patid.length != 14)
...
<div class="col-sm-10"><br>
 <center><h4 style="color:#0000FF"><b>Local  Patient Search</b></h4></center>
<div class="well">

<form class="role" method="POST" action="searchresult.jsp" NAME=serpat OnSubmit="return validate();">
<BR><BR>
	<INPUT class="form-control" TYPE="hidden" NAME="que" value="Local"> 
	<INPUT class="form-control" TYPE="hidden" NAME="cb" value="<%=cb%>"> 
...
<div class = "input-group">
  ...
  <center>
  <p><input class="form-control btn-primary" type="submit" value="Submit" name="Submit"></p>
  </center>
